...
public class BasePlusCommissionEmployee
    ...
    public String toString() {
        return String.format("BasePlusCommissionEmployee [%s, Base Salary: ₱%.2f, " + "Total Sale: ₱%.2f, Total Compensation: ₱%.2f]", super.toString(), baseSalary, getTotalSale(), computeSalary());
    }
