...
public class CommissionEmployee extends Employee {
    ...
    public String toString() {
        return String.format("CommissionEmployee [%s, Total Sale: ₱%.2f, " + "Commission Rate: %.2f%%, Total Salary: ₱%.2f]", super.toString(), totalSale, getCommissionRate() * 100, computeSalary());
    }
